		...
		<div class="content">
			...
			<div class="wzk zh-shadow">
				<div class="wenzhke">
					...
					<div class="kojian">
						<button class="kojibut-tp zh-shadow"><router-link to="/pic"></router-link>图片</button>
			...
			<div class="container">
				...
				<div class="box-1">
					<div class="btzy-1 zh-shadow">
						<input type="submit" value="查看更多" @click="limitbut()" class="kedj" />
						<div class="kojwz" v-for="(gollerys, index) in gollery.slice(limit)" :key="index">
							<div class="kapbuj-bt">
								<img src="http://1t.click/by2h" class="kapbuj-tx" />
								<div style="width: 400px;">
									<p class="kpnr">末世の刀魂</p>
									<p class="kpnr-rq">发表日期：</p>
								</div>
								<div class="kapbuj-wzan">
									<!-- <button class="kjwz-but">评论</button> -->
									<button class="kjwz-but"></button>
									<button class="kjwz-but-sc"></button>
								</div>
							</div>
							<div class="kapbuj-wznr">
								<a target="_blank" :href="gollerys.address">
									<img :src="gollerys.address" class="nrimg-1" />
								</a>
							</div>
						</div>
					</div>
...
export default {
	...
	created() {
		...
		this.axios.get('http://localhost:8080/gallery').then(res => {
			...
			this.limit = parseInt(this.gollery.length * 0.8);
			// alert(parseInt(this.csyl))
			// alert(this.limit)
		});
